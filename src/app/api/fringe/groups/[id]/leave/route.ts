...
export async function DELETE(
  ...
  await sql`DELETE FROM fringe_picks WHERE group_id = ${groupId} AND user_id = ${userId}`;
  await sql`DELETE FROM fringe_group_members WHERE group_id = ${groupId} AND user_id = ${userId}`;
